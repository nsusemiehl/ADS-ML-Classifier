...
directory = ".//data//arxiv emails//042523//" # change manually
...
# print(len(file_content), type(file_content))
# arxiv_ids = re.findall(r'^arXiv:\d{4}\.\d{5}', file_content) # looks like 'arXiv:2303.11347'
# print(arxiv_ids)
# arxiv_titles = re.findall(r'^Title: .*', file_content)
...
for arxiv_id in arxiv_ids:
    ...
    pdf_link = f"http://export.arxiv.org/pdf/{arxiv_id}"
